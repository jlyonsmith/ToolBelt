...
namespace ServiceBeltStack.Tests
{
    ...
    public class CorsFeatureTests
    {
        ...
        {
            var corsFeature = new ServiceBelt.CorsFeature(
                allowOrigins: "http://localhost:1337",
                allowHeaders: ServiceBelt.CorsFeature.DefaultHeaders + ",Authorization,Accept,X-Requested-With",
                exposeHeaders: true,
